...
algo = {uproot3.const.kZLIB: ZLIB,
        uproot3.const.kLZMA: LZMA,
        uproot3.const.kLZ4: LZ4}
...
def write(context, cursor, givenbytes, compression, key, keycursor, isjagged=False):
    ...
    if algorithm == uproot3.const.kZLIB:
        algo = b"ZL"
        import zlib
    ...
    elif algorithm == uproot3.const.kLZ4:
        algo = b"L4"
        try:
            import xxhash
        except ImportError:
    ...
    elif algorithm == uproot3.const.kLZMA:
        algo = b"XZ"
        try:
            import lzma
        except ImportError:
    ...
    elif algorithm == uproot3.const.kOldCompressionAlgo:
    ...
    if "remainingbytes" in locals() and len(remainingbytes)>0:
        uproot3.write.compress.write(context, cursor, remainingbytes, compression, key, retaincursor)
