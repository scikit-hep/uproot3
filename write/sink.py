...
class Sink(object):
    ...
    def set_th1f(self, pos, Object):
        self.file.seek(pos)
        cnt, vers, packer = Object.values1()
        self.set_numbers(pos, packer, cnt, vers)
        pos = self.file.tell()
        self.file.seek(pos)
        cnt, vers, packer = Object.values2()
        self.set_numbers(pos, packer, cnt, vers)
        pos = self.file.tell()
        self.file.seek(pos)
        ...
        pos = self.file.tell()-1
        self.file.seek(pos)
        fName, fTitle = Object.streamervalue1()
        fName = fName.encode("utf-8")
        fTitle = fTitle.encode("utf-8")
        self.set_strings(pos, fName)
        pos = self.file.tell()
        self.file.seek(pos)
        self.set_strings(pos, fTitle)
        pos = self.file.tell()
        self.file.seek(pos)
        self.file.write(Object.streamervalue2())
        pos = self.file.tell()
        self.file.seek(pos)
        nbinsx, xlow, xup = Object.values4()
        ...
        pos = self.file.tell()
        self.file.seek(pos)
        self.file.write(Object.values6())
        pos = self.file.tell()
        self.file.seek(pos)
        self.file.write(Object.values7())
        pos = self.file.tell()
        self.file.seek(pos)
        self.file.write(Object.values8())